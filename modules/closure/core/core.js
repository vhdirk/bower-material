...
(function() {
  ...
  var SUFFIXES = /(-gt)?-(xs|sm|md|lg|print)/g;
  var WHITESPACE = /\s+/g;
  ...
  function registerLayoutAPI(module){
    ...
    var BREAKPOINTS     = [ "", "xxs", "gt-xxs", "xs", "gt-xs", "sm", "gt-sm", "md", "gt-md", "lg", "gt-lg", "xl", "print" ];
